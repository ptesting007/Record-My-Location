...
- (void)drawRect:(CGRect)rect
{
    ...
    CGSize leftDistanceStringSize = [leftDistanceString sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17.0f]}];
	[leftDistanceString drawInRect:CGRectMake(CGRectGetMinX(superRect) + 1.0f,
						  ...
						  withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17.0f]}];
	...
	CGSize rightDistanceStringSize = [rightDistanceString sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17.0f]}];
	...
	CGSize topDistanceStringSize = [topDistanceString sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17.0f]}];
	...
	CGSize bottomDistanceStringSize = [bottomDistanceString sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17.0f]}];
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
	...
	CGSize stringSize = [touchPontLabelString sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:17.0f]}];
